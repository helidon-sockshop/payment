...
public class RedisProducers {
    ...
    /**
     * CDI Producer for the {@code RMap} that contains payments.
     *
     * @param client the {@code RedissonClient} to use
     *
     * @return a {@code RMap} instance for the payments
     */
    @Produces
    @ApplicationScoped
    public static RMap<AuthorizationId, Authorization> payments(RedissonClient client) {
        return client.getMap("payments");
    }
